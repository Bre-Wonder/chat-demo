...
const CustomActions = ({ wrapperStyle, inconTextStyle, onSend, storage, userID }) => {
  ...
  // converts any images to blobs and also saves images to Firebase Storage
  ...
  //allows user to take a photo and send it to the chat 
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={onActionPress}>
      <View style={[styles.wrapper, wrapperStyle]}>
        <Text style={[styles.iconText, inconTextStyle]}>+</Text>
      </View>
    </TouchableOpacity>
  );
}
